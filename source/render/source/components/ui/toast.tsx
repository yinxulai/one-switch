        ...
        {toasts.map(t => {
          ...
          return (
            <div
              ...
              className={cn(
                'pointer-events-auto relative flex min-w-65 items-center gap-2.5 overflow-hidden rounded-lg border bg-popover px-3.5 py-3 text-xs text-foreground before:absolute before:inset-y-0 before:left-0 before:w-0.5',
                STYLES[t.type],
