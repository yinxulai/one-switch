...
/**
 * 必须 forwardRef：Radix 的 Slot 会把 ref 透传进来，
 * 普通函数组件接不住，React 会报「Function components cannot be given refs」。
 */
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl bg-inset p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "system-xs-regular text-text-tertiary *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-text-primary",
        className
      )}
      {...props}
    />
